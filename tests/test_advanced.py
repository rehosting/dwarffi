        ...
        "user_types": {
            ...
            "outer_struct": {
                ...
                "fields": {
                    ...
                    "arr": {
                        "offset": 4, 
                        "type": {"kind": "array", "count": 2, "subtype": {"kind": "base", "name": "int"}}
                    }
                }
            },
            ...
            "anon_union": {
                ...
                "fields": {
                    ...
                    "__anon_1": {"offset": 0, "anonymous": True, "type": {"kind": "struct", "name": "anon_struct"}}
                }
            },
            "reg_map": {
                "kind": "struct", "size": 4,
                "fields": {
                    "__anon_2": {"offset": 0, "anonymous": True, "type": {"kind": "union", "name": "anon_union"}}
                }
            }
        },
        "enums": {}, "symbols": {}
...
def test_deep_struct_initialization(adv_ffi_env: DFFI):
    ...
    outer = adv_ffi_env.new("outer_struct", {
        "inner": {"val": 42},
        "arr": [100, 200]
    })

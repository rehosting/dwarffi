...
-------------------
    ...
    python -m dwarffi.core vmlinux.isf.json.xz [options]
    ...
    def _get_value(self) -> Any:
        ...
        if isinstance(self._instance_type_def, VtypeBaseType):
            ...
            try:
                ...
                raise struct.error(
                    f"Error unpacking value for base type '{base_type_def.name}': {e}") from e
    ...
    def _set_value(self, new_value: Any):
        ...
        if isinstance(self._instance_type_def, VtypeBaseType):
            ...
            try:
                ...
                raise struct.error(
                    f"Error packing value for base type '{base_type_def.name}': {e}") from e
        elif isinstance(self._instance_type_def, VtypeEnum):
            enum_def = self._instance_type_def
            if enum_def.base is None:
                raise ValueError(
    ...
    def _read_data(self, field_type_info: Dict[str, Any], field_offset_in_struct: int, field_name_for_error: str) -> Any:
        ...
        if kind == "base":
            ...
            try:
                ...
                raise struct.error(
                    f"Error unpacking base type '{name}' for field '{field_name_for_error}': {e}") from e
            ...
            try:
                ...
                raise struct.error(
                    f"Error unpacking pointer for field '{field_name_for_error}': {e}") from e
    ...
    def _write_data(self, field_type_info: Dict[str, Any], field_offset_in_struct: int,
        ...
        if kind == "base":
            ...
            try:
                ...
                raise struct.error(
                    f"Error packing base type '{name}' for field '{field_name_for_error}': {e}") from e
            ...
            try:
                ...
                raise struct.error(
                    f"Error packing pointer for field '{field_name_for_error}': {e}") from e
            ...
            try:
                ...
                raise struct.error(
                    f"Error packing enum '{name}' for field '{field_name_for_error}': {e}") from e
            ...
            try:
                ...
                raise struct.error(
                    f"Error packing bitfield '{field_name_for_error}': {e}") from e
    ...
    if input_is_path_str:
        ...
        try:
            ...
            raise FileNotFoundError(
                f"The ISF JSON file was not found: {path_str}") from e
